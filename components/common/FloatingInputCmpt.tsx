      ...
      <div className="relative flex flex-col items-start rounded-md">
        <input
          ...
          className={cls(
            ...
            "peer block w-full appearance-none border-0 border-b-2 border-gray-300 bg-transparent px-0 py-2 text-sm text-gray-900 focus:border-amber-500 focus:outline-none focus:ring-0 focus:ring-amber-500 dark:text-white"
          )}
          value={value}
          placeholder={" "}
        />
